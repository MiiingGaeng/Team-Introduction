...
// on
var member = [
  {name:'김도현', mbti:'INTJ', hobby:'음악작업 / 사진촬영 / 영상편집', likes:'귀여운 동물친구들', tmi:'미용실 안간지 7년됐습니다! 자연펌 개꿀', vlogLink:'https://velog.io/@doni_kim/posts', gitLink:'https://github.com/woodie2933', imageSrc:'./images/도현.png'},
  {name:'김민경', mbti:'ENTP', hobby:'러닝 / 영화감상 / 야구관람', likes:'사람들', tmi:'내년 하프마라톤 도전합니다!', vlogLink:'https://velog.io/@miiing_gaeng/posts', gitLink:'https://github.com/MiiingGaeng', imageSrc:'./images/민경.png'},
  {name:'김선제', mbti:'ISTP', hobby:'게임 / 독서 / 음악감상', likes:'고양이(코코)🐈‍⬛', tmi:'고양이를 키웁니다!', vlogLink:'https://seondev01.tistory.com/', gitLink:'https://github.com/UrePu', imageSrc:'./images/선제.png'},
  {name:'윤주하', mbti:'INTP', hobby:'클라이밍 / 영화감상 / 게임', likes:'여행', tmi:'영어 이름 Judy 입니다!🐰', vlogLink:'https://ijooha.tistory.com/', gitLink:'https://github.com/ijooha16', imageSrc:'./images/주하.png'},
  {name:'이정민', mbti:'INFJ', hobby:'운동 / OTT관람 / 게임', likes:'엽떡과 피자', tmi:'엽떡 혼자 다 먹을 수 있습니다', vlogLink:'https://jungmin7618.tistory.com/', gitLink:'https://github.com/JungminLee97', imageSrc:'./images/정민.png'}
];
